...
import { computed, defineComponent, provide, ref, watch } from 'vue'; // Types
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return _withDirectives(_createVNode(props.tag, {
        ...
        }, [(_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots), props.showArrows !== false && _createVNode("div", {
