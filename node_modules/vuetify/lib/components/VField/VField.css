...
.v-field--error .v-messages,
.v-field--error .v-icon, .v-field--disabled .v-messages,
.v-field--disabled .v-icon {
  color: inherit;
}
.v-field .v-label {
  color: inherit;
...
.v-field--variant-filled.v-field--focused .v-label, .v-field--variant-outlined.v-field--focused .v-label, .v-field--variant-underlined.v-field--focused .v-label {
  color: inherit;
}
...
.v-field:hover .v-field__clearable, .v-input--focused .v-field__clearable, .v-field--persistent-clear .v-field__clearable {
  opacity: 1;
}
...
.v-input--disabled .v-label.v-field-label, .v-input--error .v-label.v-field-label {
  color: inherit;
}
